...
public class BridgerGame extends HyriGame<BridgerGamePlayer> {
    ...
    public static NPCSkin NPC_SKIN = new NPCSkin("",
    ...
    public BridgerGame(IHyrame hyrame, Bridger plugin) {
        super(hyrame, plugin, "bridger", "Bridger", BridgerGamePlayer.class);
        this.plugin = plugin;
        this.maxPlayers = 50;
        this.minPlayers = 1;
    ...
    public void handleLogin(Player player) {
        ...
        player.teleport(this.plugin.getConfiguration().getSpawnLocationOnFirstIsland());
